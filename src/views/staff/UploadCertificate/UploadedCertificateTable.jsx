...
const columns = [
  ...
  { field: "birthday", headerName: "Ngày sinh", width: 100, type: "string" },
  { field: "gender", headerName: "Giới tính", type: "string" },
  { field: "university", headerName: "Trường", type: "string" },
  { field: "faculty", headerName: "Ngành học", width: 200, type: "string" },
  { field: "degree", headerName: "Loại bằng", width: 200, type: "string" },
  { field: "gradyear", headerName: "Năm tốt nghiệp", width: 200, type: "string" },
  { field: "level", headerName: "Xếp loại", width: 200, type: "string" },
  { field: "eduform", headerName: "Hình thức đào tạo", width: 200, type: "string" },
  { field: "issuelocation", headerName: "Nơi cấp", width: 200, type: "string" },
